...
<header class="top"><div class="wrap"><a class="brand" href="/"><svg width="28" height="28" viewBox="5.4 5.4 21.2 21.2" aria-hidden="true"><path d="M7 25 A18 18 0 0 1 25 7" fill="none" stroke="var(--glyph)" stroke-width="3.2" stroke-linecap="round"/></svg><span class="name">Bifrost</span></a><nav class="top"><a href="/">Your bridge</a><a href="/docs/">How to use it</a><a href="/docs/cli/">Command line</a><a href="https://kineuro.se">kineuro.se</a></nav></div></header>
